...
class _RenderEditable extends RenderBox
  ...
  void _computeTextMetricsIfNeeded() {
    final (double minWidth, double maxWidth) =
        _adjustConstraints(minWidth: constraints.minWidth, maxWidth: constraints.maxWidth);
  ...
  Size computeDryLayout(covariant BoxConstraints constraints) {
    ...
    _textIntrinsics
      ..setPlaceholderDimensions(layoutInlineChildren(
          constraints.maxWidth, ChildLayoutHelper.dryLayoutChild, ChildLayoutHelper.getDryBaseline))
      ..layout(minWidth: minWidth, maxWidth: maxWidth);
    final double width =
        forceLine ? constraints.maxWidth : constraints.constrainWidth(_textIntrinsics.size.width + _caretMargin);
  ...
  void performLayout() {
    ...
    _placeholderDimensions =
        layoutInlineChildren(constraints.maxWidth, ChildLayoutHelper.layoutChild, ChildLayoutHelper.getBaseline);
    final (double minWidth, double maxWidth) =
        _adjustConstraints(minWidth: constraints.minWidth, maxWidth: constraints.maxWidth);
    _textPainter
  ...
  Offset calculateBoundedFloatingCursorOffset(Offset rawCursorOffset, {bool? shouldResetOrigin}) {
    ...
    final double bottomBound =
        math.min(size.height, _textPainter.height) - preferredLineHeight + floatingCursorAddedMargin.bottom;
...
class _CaretPainter extends RenderEditablePainter {
  ...
  // zmtzawqlp
  void paintRegularCursor(Canvas canvas, _RenderEditable renderEditable, Color caretColor, TextPosition textPosition) {
...
// zmtzawqlp
  ...
  void paint(Canvas canvas, Size size, _RenderEditable renderEditable) {
    ...
    // zmtzawqlp
    final TextSelection? selection = (renderEditable as ExtendedRenderEditable).getActualSelection();
